...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Sat Nov 26 02:55:49 2011
...
$(TARGET): ui_jeopardy.h ui_gamefield.h ui_answer.h ui_editor.h ui_podium.h ui_doublejeopardy.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/jeopardy1.0.0/ && $(COPY_FILE) --parents jeopardy.h player.h gamefield.h answer.h editor.h podium.h doublejeopardy.h .tmp/jeopardy1.0.0/ && $(COPY_FILE) --parents main.cpp jeopardy.cpp player.cpp gamefield.cpp answer.cpp editor.cpp podium.cpp doublejeopardy.cpp .tmp/jeopardy1.0.0/ && $(COPY_FILE) --parents jeopardy.ui gamefield.ui answer.ui editor.ui podium.ui doublejeopardy.ui .tmp/jeopardy1.0.0/ && (cd `dirname .tmp/jeopardy1.0.0` && $(TAR) jeopardy1.0.0.tar jeopardy1.0.0 && $(COMPRESS) jeopardy1.0.0.tar) && $(MOVE) `dirname .tmp/jeopardy1.0.0`/jeopardy1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/jeopardy1.0.0
...
compiler_uic_make_all: ui_jeopardy.h ui_gamefield.h ui_answer.h ui_editor.h ui_podium.h ui_doublejeopardy.h
compiler_uic_clean:
	-$(DEL_FILE) ui_jeopardy.h ui_gamefield.h ui_answer.h ui_editor.h ui_podium.h ui_doublejeopardy.h
...
ui_doublejeopardy.h: doublejeopardy.ui
	/usr/bin/uic-qt4 doublejeopardy.ui -o ui_doublejeopardy.h
